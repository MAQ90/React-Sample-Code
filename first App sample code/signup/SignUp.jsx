...
handleSignUp(ev){
  ...
  firebase.auth().createUserWithEmailAndPassword(credential.uName, credential.passWord).then((credential) => {
  ...
  return (
    ...
    <div className='log-Container'>
      <MUI.Paper className='log-paper' zDepth={2}>
        ...
        {finished && (<MUI.FlatButton label="SignUp" primary={true} onClick={this.handleSignUp.bind(this)} />
